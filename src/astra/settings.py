...
class Settings(BaseSettings):
    ...
    fast_timeout_seconds: float = Field(default=2.0, description="Fast tier timeout in seconds")
    deep_timeout_seconds: float = Field(default=8.0, description="Deep tier engine timeout in seconds")
