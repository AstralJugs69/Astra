...
BENCHMARK_TASKS: Dict[str, TaskSpec] = {
    ...
    "tb-sqlite-corrupt-btree-repair": TaskSpec(
        ...
        oracle_command="sqlite3 data/recovered.db 'PRAGMA integrity_check; SELECT count(*) FROM transactions;'",
        precondition_command="sqlite3 data/corrupt.db 'PRAGMA integrity_check;'",
